...
namespace DCoreyDuke.CodeBase
{
    ...
    public class Timestamp
    {
        public Timestamp()
        {
            ...
            this.Milisecond = DateTime.Now.Millisecond;
        }
        ...
        {
            return string.Format("{0}/{1}/{2} {3}:{4}:{5}:{6}", this.Month, this.Day, this.Year, this.Hour, this.Minute, this.Second, this.Milisecond);
        }
